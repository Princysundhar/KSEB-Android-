...
import com.example.kseb.databinding.ActivityHomeBinding;
...
//        });
        ...
        t1 = headerView.findViewById(R.id.textView1);
        t2 = headerView.findViewById(R.id.textView2);
////        img = headerView.findViewById(R.id.imageView);
////
        SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String ip = sh.getString("ipaddress", "");
//
        String url = "http://" + ip + ":1234" ;   // For Image
...
//            return true;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.nav_gallery){
            Intent i = new Intent(getApplicationContext(),view_previous_bill.class);
            startActivity(i);
        }
        if(id == R.id.nav_slideshow){
            Intent i = new Intent(getApplicationContext(),view_compliant.class);
            startActivity(i);
        }
        if(id == R.id.nav_slideshows){
            Intent i = new Intent(getApplicationContext(),send_rate.class);
            startActivity(i);
        }
        ...
        if(id == R.id.nav_galleryy){
            Intent i = new Intent(getApplicationContext(),view_bill.class);
            startActivity(i);
        }
//        return false;
